  ...
  const { data: payments = [], isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        // 2) Récupérer tous les paiements liés aux baux des propriétés de cette agence
        ...
        // 3) Transformer les données du format snake_case au format camelCase avec détails
