...
export default function AgencyPaymentsPage() {
    ...
    queryFn: async () => {
      ...
      try {
        ...
        const transformedPayments: PaymentWithDetails[] = (paymentsData || []).map(payment => ({
          ...
          propertyTitle: payment.leases?.properties?.title || 'Propriété inconnue',
        ...
        throw new Error(`Impossible de récupérer les paiements: ${error.message}`);
      }
    },
    enabled: !!agencyId,
  ...
  const getPaymentTypeBadge = (type: string) => {
    switch (type) {
      case "deposit":
        return <Badge className="bg-blue-100 text-blue-700 border-blue-200">💰 Caution</Badge>;
      case "agency_fee":
        return <Badge className="bg-purple-100 text-purple-700 border-purple-200">🏢 Frais d'agence</Badge>;
      case "rent":
        return <Badge className="bg-green-100 text-green-700 border-green-200">🏠 Loyer</Badge>;
      case "deposit_return":
        return <Badge className="bg-orange-100 text-orange-700 border-orange-200">↩️ Remboursement</Badge>;
      case "initial":
        return <Badge className="bg-indigo-100 text-indigo-700 border-indigo-200">🎯 Initial</Badge>;
      default:
  ...
  return (
      <div className="container mx-auto p-6">
        <Alert className="border-red-200 bg-red-50">
          <AlertTriangle className="h-4 w-4" />
          <AlertDescription>
            Erreur lors du chargement des paiements. Veuillez réessayer.
          </AlertDescription>
        </Alert>
      </div>
    );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Suivi et gestion de tous vos encaissements
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <div className="flex gap-2">
              {[
                ...
                { value: 'paid', label: 'Payés', icon: CheckCircle2 },
                { value: 'pending', label: 'En attente', icon: Clock },
                { value: 'late', label: 'En retard', icon: AlertTriangle }
              ].map((status) => (
                <Button
                  key={status.value}
            ...
            >
              ...
              <option value="initial">Paiements initiaux</option>
            </select>
            ...
            <div className="flex-1 min-w-[200px]">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Rechercher par propriété, locataire ou transaction..."
                  value={searchTerm}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200/50 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-green-600">{payments.length} transactions</span>
        ...
        <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200/50 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-blue-600">Confirmés</span>
        ...
        <Card className="bg-gradient-to-br from-red-50 to-pink-50 border-red-200/50 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-red-600">Urgents</span>
            ...
            <CardHeader className="bg-gradient-to-r from-immoo-navy/5 to-immoo-gold/5">
              <CardTitle className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  {filteredPayments.length} résultats
                  </div>
              </CardTitle>
            </CardHeader>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {searchTerm || selectedStatus !== 'all' || selectedType !== 'all'
                      ...
                      : 'Les paiements de vos propriétés apparaîtront ici'
                    }
                    </p>
                  </div>
                ) : (
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                Échéance: {payment.dueDate ? new Date(payment.dueDate).toLocaleDateString('fr-FR') : 'N/A'}
                              </div>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
            <CardHeader className="bg-gradient-to-r from-immoo-navy/5 to-immoo-gold/5">
              <CardTitle className="flex items-center gap-2">
                ...
                Gestion en masse des paiements
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="text-center py-12">
                <CreditCard className="h-16 w-16 text-muted-foreground mx-auto mb-4 opacity-50" />
                <p className="text-lg font-medium text-muted-foreground mb-2">Gestion en masse</p>
                    <p className="text-sm text-muted-foreground">
                  Fonctionnalité de traitement en lot des paiements - Prochainement disponible
                    </p>
                  </div>
            </CardContent>
          </Card>
