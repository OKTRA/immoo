              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-white/60 dark:bg-gray-800/60 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    ...
                    <h4 className="font-medium">Prix principal</h4>
                  </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center mb-3">
                    ...
                    {property.agencyVerified && (
                      <ShieldCheck className="h-5 w-5 ml-2 text-green-500" title="Agence vérifiée" />
                    )}
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-muted-foreground">
              ...
              {property.updatedAt && (
                <div className="flex items-center space-x-2">
                  ...
                  <span>Mis à jour le {new Date(property.updatedAt).toLocaleDateString('fr-FR')}</span>
                </div>
              )}
            </div>
          </div>
