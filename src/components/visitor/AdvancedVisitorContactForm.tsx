...
import { Shield, UserCheck, Phone, Mail, Lock, X, Sparkles } from 'lucide-react';
import { VisitorContactForm as VisitorContactFormData } from '@/services/visitorContactService';

interface AdvancedVisitorContactFormProps {
  agencyName: string;
...
export default function AdvancedVisitorContactForm({
  agencyName,
  onSubmit,
  isLoading,
  onClose,
  recognitionAttempted = false
}: AdvancedVisitorContactFormProps) {
            ...
            {recognitionAttempted && (
              <div className="mt-3 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <div className="flex items-center gap-2 text-xs text-blue-700 dark:text-blue-300">
                  ...
                  <span>Reconnaissance automatique tentée</span>
                </div>
              </div>
            )}
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-3 rounded-lg border border-blue-200/50 dark:border-blue-800/50">
                <p className="text-xs text-blue-700 dark:text-blue-300 flex items-start gap-2">
                  ...
                  <span>
                    Vos informations sont sécurisées et nous permettent de vous reconnaître lors de vos prochaines visites
                  </span>
                </p>
              </div>
